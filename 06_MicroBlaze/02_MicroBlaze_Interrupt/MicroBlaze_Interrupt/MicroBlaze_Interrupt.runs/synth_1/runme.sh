...
HD_PWD='Z:/work/git/LabVIEW_Fpga/06_MicroBlaze/02_MicroBlaze_Interrupt/MicroBlaze_Interrupt/MicroBlaze_Interrupt.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log d_microblaze_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source d_microblaze_wrapper.tcl
