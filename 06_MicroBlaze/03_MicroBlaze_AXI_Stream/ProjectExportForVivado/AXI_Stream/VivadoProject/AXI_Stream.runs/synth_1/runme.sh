...
HD_PWD='Z:/work/git/LabVIEW_Fpga/06_MicroBlaze/03_MicroBlaze_AXI_Stream/ProjectExportForVivado/AXI_Stream/VivadoProject/AXI_Stream.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PXIe6592R_Top_Gen2x8.vds -m64 -mode batch -messageDb vivado.pb -notrace -source PXIe6592R_Top_Gen2x8.tcl
