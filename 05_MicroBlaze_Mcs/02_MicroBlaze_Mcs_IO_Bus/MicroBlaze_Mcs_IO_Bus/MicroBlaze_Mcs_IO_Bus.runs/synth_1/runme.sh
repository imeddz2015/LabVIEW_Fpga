...
HD_PWD='Z:/work/git/LabVIEW_Fpga/05_MicroBlaze_Mcs/02_MicroBlaze_Mcs_IO_Bus/MicroBlaze_Mcs_IO_Bus/MicroBlaze_Mcs_IO_Bus.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log d_mcs_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source d_mcs_wrapper.tcl
