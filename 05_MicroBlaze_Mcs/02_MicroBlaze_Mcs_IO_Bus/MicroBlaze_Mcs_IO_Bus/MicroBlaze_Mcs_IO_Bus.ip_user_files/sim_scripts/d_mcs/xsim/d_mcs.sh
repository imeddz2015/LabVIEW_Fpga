...
elaborate()
{
  xelab --relax --debug typical --mt auto -wto 20b9241950de4bd6b12cada175052419 -m64 -L microblaze_v9_5_3 -L iomodule_v3_0 -L lmb_bram_if_cntlr_v4_0 -L lmb_v10_v3_0 -L axi_lite_ipif_v3_0 -L mdm_v3_2 -L microblaze_mcs_v2_3_3 -L xil_defaultlib -L secureip --snapshot d_mcs xil_defaultlib.d_mcs -log elaborate.log
}
