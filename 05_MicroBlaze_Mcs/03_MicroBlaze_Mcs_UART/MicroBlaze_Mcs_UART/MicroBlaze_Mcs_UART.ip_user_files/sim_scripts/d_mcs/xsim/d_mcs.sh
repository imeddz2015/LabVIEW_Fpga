...
#
# Generated by Vivado on Wed Jun 28 23:26:31 -0400 2017
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb d_mcs.wdb xsim.dir)
...
elaborate()
{
  xelab --relax --debug typical --mt auto -wto 169336d94f5d460a929321345b792083 -m64 -L microblaze_v9_5_3 -L iomodule_v3_0 -L lmb_bram_if_cntlr_v4_0 -L lmb_v10_v3_0 -L axi_lite_ipif_v3_0 -L mdm_v3_2 -L microblaze_mcs_v2_3_3 -L xil_defaultlib -L secureip --snapshot d_mcs xil_defaultlib.d_mcs -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim d_mcs -key {Behavioral:sim_1:Functional:d_mcs} -tclbatch cmd.tcl -log simulate.log
}
# Script usage
usage()
{
